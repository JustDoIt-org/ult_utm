<x-section.modal maxWidth="md" :name="$this->modal_name" :title="$this->title" method="save">
    <div class="flex flex-col mb-5">
        <label for="form.tipe_kunjungan">Tipe Kunjungan</label>
        <x-element.select.dropdown wire:model.change="form.tipe_kunjungan">
            <option>---Pilih Tipe Kunjungan---</option>

            @foreach ($this->tipe_kunjungan as $value)
    ...
    <div x-data="{ uploading: false, progress: 0 }" x-on:livewire-upload-start="uploading = true"
        ...
        @if ($form->tipe_kunjungan != "langsung")
            <div class="relative">
