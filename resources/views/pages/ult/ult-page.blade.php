...
<body class="max-w-full overflow-x-hidden" x-data="{ mobileNav: false }">
    ...
    <nav class="flex items-center">
      ...
      <div class="ms-auto hidden lg:flex items-center">
        <ul class="flex gap-x-4">
          ...
          <li><a href="#"
              class="border-transparent hover:border-b-4 hover:pb-1 hover:border-b-slate-700 transition duration-700">Home</a>
          </li>
          <li><a href="#"
              class="border-transparent hover:border-b-4 hover:pb-1 hover:border-b-slate-700 transition duration-700">Tentang
              ULT</a></li>
          <li><a href="#"
              class="border-transparent hover:border-b-4 hover:pb-1 hover:border-b-slate-700 transition duration-700">Aspirasi
              &amp; Pengaduan</a></li>
          <li><a href="#"
              class="border-transparent hover:border-b-4 hover:pb-1 hover:border-b-slate-700 transition duration-700">Kontak</a>
          </li>
        </ul>
        <a href="#"
    ...
    <div class="w-full lg:w-1/2 h-[636px] flex gap-5 order-last lg:order-first" id="galery">
      <div class="w-1/2 flex flex-col gap-5">
        <div class="h-1/2 w-full bg-cover bg-center bg-no-repeat rounded-xl shadow-xl"
          style="background-image: url(assets/img/hero-image-4.jpg)"></div>
        <div class="h-1/2 w-full bg-cover bg-center bg-no-repeat rounded-xl shadow-xl"
          style="background-image: url(assets/img/hero-image-5.jpg)"></div>
      </div>
