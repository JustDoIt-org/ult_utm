...
<div class="mt-3 capitalize max-w-72" x-data="{ uploading: false, progress: 0 }" x-on:livewire-upload-start="uploading = true"
  ...
  <div>
    <label
      ...
      for="photo" wire:loading.class.remove="hover:bg-yellow-700 cursor-pointer" wire:target="photo"
      wire:loading.class="opacity-50">
      <span class=" flex gap-3" wire:loading.remove wire:target="photo">
        Upload
        file
    ...
    <input
      ...
      id="photo" type="file" wire:model.live="photo" accept="image/png, image/jpeg">
  </div>
